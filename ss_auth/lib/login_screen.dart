              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.lock_rounded, color: Color(0xFF080B12), size: 22),
                        ),
                    ...
                    Text('Welcome\nback.', style: GoogleFonts.syne(fontSize: 40, fontWeight: FontWeight.w800, color: const Color(0xFFEEF0F6), height: 1.05, letterSpacing: -1.5)),
                    const SizedBox(height: 12),
                    Text('Sign in to access your lockers.', style: GoogleFonts.dmSans(fontSize: 15, color: const Color(0xFF6A7090), fontWeight: FontWeight.w300)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {},
                          child: Text('Forgot password?', style: GoogleFonts.dmSans(fontSize: 13, color: const Color(0xFFF5A623), fontWeight: FontWeight.w500)),
                        ),
                      ],
                    ),
                    const SizedBox(height: 8),
                    ...
                    Row(children: [
                      ...
                      Padding(
                        ...
                        child: Text('or continue with', style: GoogleFonts.dmSans(color: const Color(0xFF6A7090), fontSize: 12)),
                      ),
                      const Expanded(child: Divider(color: Color(0x12FFFFFF))),
                    ]),
                    ...
                    Center(
                      child: GestureDetector(
                        ...
                        child: RichText(
                          text: TextSpan(children: [
                            TextSpan(text: "Don't have an account?  ", style: GoogleFonts.dmSans(color: const Color(0xFF6A7090), fontSize: 14)),
                            TextSpan(text: 'Sign up', style: GoogleFonts.dmSans(color: const Color(0xFFF5A623), fontSize: 14, fontWeight: FontWeight.w600)),
                          ]),
                        ),
                      ),
                    ),
      ...
      child: Container(
        ...
        child: Center(
          child: loading
              ...
              : Text(label, style: GoogleFonts.syne(fontSize: 15, fontWeight: FontWeight.w700, color: const Color(0xFF080B12))),
        ),
      ),
    );
  }
